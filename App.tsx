...
const App: React.FC = () => {
  ...
  const activeLogo = useMemo(() => {
    return logos.find(l => l.id === settings.activeLogoId) || logos[0];
  }, [logos, settings.activeLogoId]);
                  ...
                  <section className="bg-red-600/5 border-y border-red-500/20 py-24">
                    <div className="container mx-auto px-4">
                      <div className="flex flex-col items-center mb-16 text-center">
                        <span className="text-red-500 text-[11px] font-black uppercase tracking-[0.5em] mb-4 bg-red-500/10 px-4 py-1 rounded-full border border-red-500/20">
                          Oferta Limitada
                        </span>
                        <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter text-white">
                          PROMO<span className="text-red-500">ÇÃO</span>
                        </h2>
                        <p className="text-zinc-500 max-w-md mt-6 text-sm uppercase tracking-widest font-medium opacity-60">
                          Garanta sua armadura com preços imbatíveis.
                        </p>
                        <div className="w-24 h-1.5 bg-red-500 mt-8 shadow-[0_0_20px_rgba(239,68,68,0.6)] rounded-full"></div>
                      </div>
            ...
            <section className="container mx-auto px-4 py-24">
              <div className="flex items-center justify-between mb-12">
                <h2 className="text-3xl font-black uppercase tracking-tighter border-l-8 border-green-500 pl-6">
                  {isBrowsing 
                    ? (activeCategory === 'All' ? 'Resultados da Busca' : categories.find(c => c.id === activeCategory)?.name)
                    : 'Coleção PV Sports'
                  }
                </h2>
              ...
              {filteredProducts.length > 0 ? (
                ...
                <div className="py-32 text-center">
                  <p className="text-zinc-600 uppercase tracking-[0.3em] font-bold text-sm">Nenhum produto encontrado com esses filtros.</p>
